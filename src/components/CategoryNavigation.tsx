      ...
      <div className="flex flex-wrap gap-2 justify-center">
        ...
        {categories.length > 8 && (
          <button 
            ...
            className="whitespace-nowrap px-4 py-2 rounded-full border border-gray-200 text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 hover:border-indigo-200 transition-colors flex items-center cursor-pointer"
          >
